...
function ArticleEditor(param) {
    ...
    const [tagsOpened, setTagsOpened] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const openTags = async ()=>{
        ...
        setIndustryTags(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$feed$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchIndustryTags"])(industry.id, locale));
    };
    ...
    var _industry_name, _industry_id;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        dir: isArabic ? 'rtl' : 'ltr',
        ...
        children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        tagsOpened && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-3 flex max-h-44 flex-wrap gap-2 overflow-y-auto rounded-lg bg-[#F7F9FC] p-3",
                                            children: !industry ? copy.industryFirst : industryTags.length === 0 ? copy.noTags : industryTags.map((tag)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    type: "button",
                                                    onClick: ()=>setSelectedTags((current)=>current.some((item)=>item.id === tag.id) ? current.filter((item)=>item.id !== tag.id) : [
                                                                ...current,
                                                                tag
                                                            ]),
                                                    className: "rounded-full border px-2.5 py-1 text-xs ".concat(selectedTags.some((item)=>item.id === tag.id) ? 'border-[#2378E8] text-[#2378E8]' : 'border-[#D6E0EC] bg-white text-[#65758A]'),
                                                    children: [
                                                        "#",
                                                        tag.name
                                                    ]
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$feed$2f$post$2f$IndustrySelectModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                selectedId: (_industry_id = industry === null || industry === void 0 ? void 0 : industry.id) !== null && _industry_id !== void 0 ? _industry_id : null,
...
_s(ArticleEditor, "pcP4XwNQpqjVk1j7ibb9PTfxB5o=", false, function() {
    return [
...
//# sourceMappingURL=_f8a515e8._.js.map