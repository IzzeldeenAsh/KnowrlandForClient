...
"[project]/components/project/questions/ProjectSubscopesQuestion.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function manualScopeKey(scopeId) {
    return "m:".concat(scopeId);
}
function parentScopeKey(parentId) {
    return "p:".concat(parentId);
}
...
function safeParseManualSubscopesByScope(value) {
    if (!value) return {};
    try {
        const parsed = JSON.parse(value);
        ...
        Object.entries(obj).forEach((param)=>{
            ...
            const list = subs.map((s)=>{
                var _this, _this1;
                return {
                    id: typeof ((_this = s) === null || _this === void 0 ? void 0 : _this.id) === 'string' ? String(s.id) : '',
                    name: typeof ((_this1 = s) === null || _this1 === void 0 ? void 0 : _this1.name) === 'string' ? String(s.name) : ''
                };
...
function safeParseStoredSuggestedScopes(value) {
    if (!value) return [];
    try {
        return coerceScopeParents(JSON.parse(value));
    } catch (e) {
        return [];
    }
}
...
async function fetchServiceComponents(params) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$projectApiError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertProjectApiResponse"])(res, 'Failed to load service components.');
    const json = await res.json();
    return (json.data || []).map((item)=>item.slug || item.name).filter((slug)=>Boolean(slug && slug.trim()));
}
async function syncScopes(params) {
    const formData = new FormData();
    params.scopes.forEach((scope, i)=>{
        formData.append("scopes[".concat(i, "][name]"), scope.name);
        scope.subscopes.forEach((subscope, j)=>{
            formData.append("scopes[".concat(i, "][subscopes][").concat(j, "][name]"), subscope.name);
            (subscope.files || []).forEach((file, k)=>{
                formData.append("scopes[".concat(i, "][subscopes][").concat(j, "][file][").concat(k, "]"), file);
            });
        });
    });
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$projectApiError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertProjectApiResponse"])(res, 'Failed to save project scope.');
}
function formatBytes(bytes) {
    ...
    return "".concat(value.toFixed(value >= 10 || idx === 0 ? 0 : 1), " ").concat(units[idx]);
}
function getFileExtension(fileName) {
    var _String_split_pop;
    return ((_String_split_pop = String(fileName || '').split('.').pop()) === null || _String_split_pop === void 0 ? void 0 : _String_split_pop.toLowerCase()) || '';
}
function getFileIconPath(file) {
    const extension = getFileExtension(file.name);
    const mimeType = file.type.toLowerCase();
    const normalizedExtension = extension === 'jpeg' ? 'jpg' : extension === 'powerpoint' ? 'ppt' : extension;
    ...
    const iconName = iconByExtension[normalizedExtension] || (mimeType.includes('presentation') ? 'ppt' : '') || (mimeType.includes('spreadsheet') || mimeType.includes('excel') ? 'xlsx' : '') || (mimeType.includes('word') ? 'docx' : '') || (mimeType.includes('pdf') ? 'pdf' : '') || (mimeType.includes('zip') ? 'zip' : '') || (mimeType.startsWith('image/') ? 'jpg' : '');
    return iconName ? "/file-icons/".concat(iconName, ".svg") : null;
}
function AttachmentTile(param) {
    let { file, onRemove, isRTL } = param;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "h-6 w-5 shrink-0 overflow-hidden",
                children: iconPath ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    src: iconPath,
                    alt: "",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "pointer-events-none absolute bottom-full z-20 mb-1.5 hidden whitespace-nowrap rounded-md bg-slate-900/90 px-2 py-1 text-[10px] font-semibold text-white shadow-lg group-hover:block ".concat(isRTL ? 'end-0' : 'start-0'),
                children: [
                    file.name,
                    " · ",
...
function ProjectSubscopesQuestion(param) {
    let { locale } = param;
    _s();
    ...
    const [childIdsByParent, setChildIdsByParent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [manualSubscopesByScope, setManualSubscopesByScope] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [finalizedManualSubscopeKeys, setFinalizedManualSubscopeKeys] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [confirmedManualSubscopeKeys, setConfirmedManualSubscopeKeys] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [attachmentsByKey, setAttachmentsByKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [activeChildKey, setActiveChildKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [inputNonce, setInputNonce] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const serviceId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectSubscopesQuestion.useMemo[serviceId]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            return safeParseSelectedServiceId(window.sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceIdsKey(locale)));
        }
    }["ProjectSubscopesQuestion.useMemo[serviceId]"], [
        locale
    ]);
    const projectUuid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectSubscopesQuestion.useMemo[projectUuid]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$projectRequestUuid$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readStoredProjectRequestUuid"])(locale)
    }["ProjectSubscopesQuestion.useMemo[projectUuid]"], [
        locale
    ]);
    const manualScopes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectSubscopesQuestion.useMemo[manualScopes]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            return safeParseManualScopes(window.sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceManualScopesKey(locale)));
        }
    }["ProjectSubscopesQuestion.useMemo[manualScopes]"], [
        locale
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSubscopesQuestion.useEffect": ()=>{
            const timer = window.setTimeout({
                "ProjectSubscopesQuestion.useEffect.timer": ()=>setEntered(true)
            }["ProjectSubscopesQuestion.useEffect.timer"], 30);
            return ({
                "ProjectSubscopesQuestion.useEffect": ()=>window.clearTimeout(timer)
            })["ProjectSubscopesQuestion.useEffect"];
        }
    }["ProjectSubscopesQuestion.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSubscopesQuestion.useEffect": ()=>{
            try {
                ...
                setChildIdsByParent(safeParseObject(window.sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceScopeChildIdsByParentKey(locale))));
                const storedManualSubscopes = safeParseManualSubscopesByScope(window.sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceManualSubscopesByScopeKey(locale)));
                setManualSubscopesByScope(storedManualSubscopes);
                const storedSubscopeKeys = Object.entries(storedManualSubscopes).flatMap({
                    "ProjectSubscopesQuestion.useEffect.storedSubscopeKeys": (param)=>{
                        let [scopeKey, subs] = param;
                        return subs.filter({
                            "ProjectSubscopesQuestion.useEffect.storedSubscopeKeys": (sub)=>Boolean(String(sub.name || '').trim())
                        }["ProjectSubscopesQuestion.useEffect.storedSubscopeKeys"]).map({
                            "ProjectSubscopesQuestion.useEffect.storedSubscopeKeys": (sub)=>"".concat(scopeKey, ":").concat(sub.id)
                        }["ProjectSubscopesQuestion.useEffect.storedSubscopeKeys"]);
                    }
                }["ProjectSubscopesQuestion.useEffect.storedSubscopeKeys"]);
                ...
                try {
                    ...
                    window.sessionStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceManualSubscopesByScopeKey(locale), JSON.stringify(safeParseManualSubscopesByScope(window.sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceManualSubscopesByScopeKey(locale)))));
                } catch (e) {
                // ignore
                }
            } catch (e) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSubscopesQuestion.useEffect": ()=>{
            ...
            setManualSubscopesByScope({
                "ProjectSubscopesQuestion.useEffect": (prev)=>{
                    const allowedManualKeys = new Set(manualScopes.map({
                        "ProjectSubscopesQuestion.useEffect": (s)=>manualScopeKey(s.id)
                    }["ProjectSubscopesQuestion.useEffect"]));
                    const manualScopeNameByKey = new Map(manualScopes.map({
                        "ProjectSubscopesQuestion.useEffect": (s)=>[
                                manualScopeKey(s.id),
                                String(s.name || '').trim()
                            ]
                    }["ProjectSubscopesQuestion.useEffect"]));
                    ...
                    Object.entries(prev).forEach({
                        "ProjectSubscopesQuestion.useEffect": (param)=>{
                            let [scopeKey, subs] = param;
                            ...
                            if (scopeKey.startsWith('m:') && allowedManualKeys.has(scopeKey)) {
                                ...
                                const placeholderOnly = subs.length === 1 && String(((_subs_ = subs[0]) === null || _subs_ === void 0 ? void 0 : _subs_.name) || '').trim() === expectedName && (attachmentStore.get("".concat(scopeKey, ":").concat((_subs_1 = subs[0]) === null || _subs_1 === void 0 ? void 0 : _subs_1.id)) || []).length === 0;
                                if (!placeholderOnly) {
                                    next[scopeKey] = subs;
                                }
                            }
                    ...
                    try {
                        window.sessionStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceManualSubscopesByScopeKey(locale), JSON.stringify(next));
                    } catch (e) {
                    // ignore
                    }
                    return next;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSubscopesQuestion.useEffect": ()=>{
            let cancelled = false;
            const load = {
                "ProjectSubscopesQuestion.useEffect.load": async ()=>{
                    setError(null);
                    if (!serviceId) {
                        setScopes([]);
                        return;
                    ...
                    try {
                        ...
                        if (isOther) {
                            const stored = safeParseStoredSuggestedScopes(window.sessionStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceAiSuggestedScopesKey(locale)));
                            if (stored.length > 0) {
                        ...
                        const json = await res.json();
                        let list = isOther ? extractSuggestedScopesFromProjectRequest(json) : coerceScopeParents((_this = json) === null || _this === void 0 ? void 0 : _this.data);
            ...
            }["ProjectSubscopesQuestion.useEffect.load"];
            void load();
            return ({
                "ProjectSubscopesQuestion.useEffect": ()=>{
                    cancelled = true;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectSubscopesQuestion.useEffect": ()=>{
            const obj = {};
            Array.from(attachmentStore.entries()).forEach({
                "ProjectSubscopesQuestion.useEffect": (param)=>{
                    let [key, files] = param;
                    obj[key] = files;
                }
    ...
    const selectedParents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectSubscopesQuestion.useMemo[selectedParents]": ()=>{
            if (!scopes) return [];
            const set = new Set(selectedParentIds);
            return scopes.filter({
                "ProjectSubscopesQuestion.useMemo[selectedParents]": (s)=>set.has(s.id)
            }["ProjectSubscopesQuestion.useMemo[selectedParents]"]);
        }
    }["ProjectSubscopesQuestion.useMemo[selectedParents]"], [
        scopes,
    ...
    const isManualSubscopeConfirmed = (scopeKey, subscopeId)=>confirmedManualSubscopeKeys.includes("".concat(scopeKey, ":").concat(subscopeId));
    const isManualSubscopeFinalized = (scopeKey, subscopeId)=>finalizedManualSubscopeKeys.includes("".concat(scopeKey, ":").concat(subscopeId));
    const countConfirmedSubscopes = (scopeKey)=>{
        const list = manualSubscopesByScope[scopeKey] || [];
        return list.filter((s)=>Boolean(String(s.name || '').trim()) && isManualSubscopeConfirmed(scopeKey, s.id)).length;
    };
    const totalSelectedSubscopes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectSubscopesQuestion.useMemo[totalSelectedSubscopes]": ()=>{
            let total = 0;
            selectedParents.forEach({
                "ProjectSubscopesQuestion.useMemo[totalSelectedSubscopes]": (p)=>{
        ...
        childIdsByParent,
        confirmedManualSubscopeKeys,
        manualSubscopesByScope,
        selectedParents
    ]);
    const manualTotalSubscopes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProjectSubscopesQuestion.useMemo[manualTotalSubscopes]": ()=>{
            return manualScopes.reduce({
                "ProjectSubscopesQuestion.useMemo[manualTotalSubscopes]": (total, scope)=>{
            ...
            }["ProjectSubscopesQuestion.useMemo[manualTotalSubscopes]"], 0);
        }
    }["ProjectSubscopesQuestion.useMemo[manualTotalSubscopes]"], [
        confirmedManualSubscopeKeys,
        manualScopes,
    ...
    const canContinue = manualTotalSubscopes + totalSelectedSubscopes > 0 && !loading && !submitting && !(selectedParentIds.length > 0 && scopes === null);
    ...
    const toggleChild = (parentId, childId)=>{
        setChildIdsByParent((prev)=>{
            ...
            const next = existing.includes(childId) ? existing.filter((x)=>x !== childId) : [
                ...existing,
                childId
            ];
            const updated = {
            ...
            if (!next.includes(childId)) {
                const fileKey = "".concat(parentId, ":").concat(childId);
    ...
    const areAllChildrenSelected = (parentId, children)=>{
        if (children.length === 0) return false;
        const list = childIdsByParent[String(parentId)] || [];
        return children.every((child)=>list.includes(child.id));
    };
    const toggleSelectAllChildren = (parentId, children)=>{
        if (children.length === 0) return;
        const allSelected = areAllChildrenSelected(parentId, children);
        const key = String(parentId);
        if (allSelected) {
            children.forEach((child)=>attachmentStore.delete("".concat(parentId, ":").concat(child.id)));
            setAttachmentsByKey((prev)=>{
                const copy = {
                    ...prev
                };
                children.forEach((child)=>delete copy["".concat(parentId, ":").concat(child.id)]);
                return copy;
            });
            setChildIdsByParent((prev)=>({
                    ...prev,
    ...
    const openFilePicker = (parentId, childId)=>{
        openFilePickerKey("".concat(parentId, ":").concat(childId));
    };
    ...
    const persistManualSubscopes = (next)=>{
    ...
    const addManualSubscope = function(scopeKey) {
        let initialName = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : '';
    ...
    const updateManualSubscopeName = (scopeKey, subscopeId, name)=>{
        const existing = manualSubscopesByScope[scopeKey] || [];
        const nextList = existing.map((s)=>s.id === subscopeId ? {
                ...s,
                name
            } : s);
        persistManualSubscopes({
            ...manualSubscopesByScope,
            [scopeKey]: nextList
        });
    };
    const confirmManualSubscope = (scopeKey, subscopeId)=>{
        const existing = manualSubscopesByScope[scopeKey] || [];
        const target = existing.find((s)=>s.id === subscopeId);
        const trimmed = String((target === null || target === void 0 ? void 0 : target.name) || '').trim();
        if (!trimmed) return;
        setFinalizedManualSubscopeKeys((prev)=>{
            const key = "".concat(scopeKey, ":").concat(subscopeId);
            return prev.includes(key) ? prev : [
                ...prev,
                key
            ];
        });
    ...
    const toggleManualSubscopeConfirmed = (scopeKey, subscopeId)=>{
        const key = "".concat(scopeKey, ":").concat(subscopeId);
        setConfirmedManualSubscopeKeys((prev)=>{
            const next = prev.includes(key) ? prev.filter((item)=>item !== key) : [
                ...prev,
                key
            ];
    ...
    const removeManualSubscope = (scopeKey, subscopeId)=>{
        const existing = manualSubscopesByScope[scopeKey] || [];
        ...
        setFinalizedManualSubscopeKeys((prev)=>prev.filter((key)=>key !== "".concat(scopeKey, ":").concat(subscopeId)));
        setConfirmedManualSubscopeKeys((prev)=>prev.filter((key)=>key !== "".concat(scopeKey, ":").concat(subscopeId)));
        const fileKey = "".concat(scopeKey, ":").concat(subscopeId);
        attachmentStore.delete(fileKey);
        setAttachmentsByKey((filesPrev)=>{
            const copy = {
                ...filesPrev
    ...
    const uiMode = selectedParents.length > 0 && manualScopes.length > 0 ? 'combined' : manualScopes.length > 0 ? 'manual' : 'select';
    const title = uiMode === 'manual' ? isRTL ? 'أضف النطاقات الفرعية' : 'Add subscopes' : uiMode === 'combined' ? isRTL ? 'اختر النطاقات الفرعية وأضف أخرى' : 'Select and add subscopes' : isRTL ? 'اختر النطاقات الفرعية' : 'Select subscopes';
    const subtitle = uiMode === 'manual' ? isRTL ? 'أدخل النطاقات الفرعية، وأضف مرفقات داعمة إذا كانت تساعد الإنسايتر على فهم المتطلبات بشكل أفضل.' : 'Enter subscopes and add supporting attachments if they help the insighter understand the requirements better.' : isRTL ? 'اختر النطاقات الفرعية المطلوبة، ويمكنك إضافة نطاقات فرعية أخرى أو مرفقات داعمة تساعد الإنسايتر على فهم المتطلبات بشكل أفضل.' : 'Select the required subscopes, and add other subscopes or supporting attachments that help the insighter understand the requirements better.';
    const selectedCountLabel = (count)=>isRTL ? "".concat(count, " محدد") : "".concat(count, " selected");
    const parentSelectedCount = (parent, scopeKey)=>{
    ...
    const manualScopeSelectedCount = (scope, scopeKey)=>{
        const confirmedCount = countConfirmedSubscopes(scopeKey);
    ...
    const onContinue = async ()=>{
        ...
        try {
            window.sessionStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceScopeChildIdsByParentKey(locale), JSON.stringify(childIdsByParent));
        } catch (e) {
        // ignore
        }
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authToken$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthToken"])();
        ...
        const manualPayload = manualScopes.map((scope)=>{
            const scopeKey = manualScopeKey(scope.id);
            const rawSubscopes = manualSubscopesByScope[scopeKey] || [];
            const subscopes = rawSubscopes.filter((sub)=>isManualSubscopeConfirmed(scopeKey, sub.id)).map((sub)=>({
                    name: String(sub.name || '').trim(),
                    files: attachmentStore.get("".concat(scopeKey, ":").concat(sub.id)) || []
        ...
        const selectedParentsPayload = selectedParents.map((parent)=>{
            const scopeKey = parentScopeKey(parent.id);
            const customRaw = manualSubscopesByScope[scopeKey] || [];
            const customSubscopes = customRaw.filter((sub)=>isManualSubscopeConfirmed(scopeKey, sub.id)).map((sub)=>({
                    name: String(sub.name || '').trim(),
                    files: attachmentStore.get("".concat(scopeKey, ":").concat(sub.id)) || []
                })).filter((s)=>Boolean(s.name));
            ...
            if (children.length === 0) {
                return {
                    name: parent.name,
                    subscopes: customSubscopes.length > 0 ? customSubscopes : [
                        {
                            name: parent.name
                        }
                    ]
            ...
            const selectedChildren = children.filter((c)=>selectedChildIds.includes(c.id)).map((c)=>({
                    name: c.name,
                    files: attachmentStore.get("".concat(parent.id, ":").concat(c.id)) || []
                }));
            return {
                name: parent.name,
                subscopes: [
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$projectAddonsState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeProjectScopeSnapshot"])(locale, scopePayload.map((scope)=>({
                    name: scope.name,
                    subscopes: scope.subscopes.map((subscope)=>subscope.name)
                })));
            const slugs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$projectWizardFlow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["expandServiceComponentSlugs"])(await fetchServiceComponents({
                locale,
                token,
                serviceId,
            ...
            try {
                window.sessionStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$wizardStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectWizardStorage"].serviceComponentSlugsKey(locale), JSON.stringify(slugs));
            } catch (e) {
            // ignore
            }
            nav.goNext();
        } catch (err) {
            setError((0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$project$2f$projectApiError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProjectApiErrorMessage"])(err, isRTL ? 'تعذر حفظ نطاق المشروع.' : 'Failed to save project scope.'));
        } finally{
            setSubmitting(false);
        }
    };
    const renderAddSubscopeField = (scopeKey)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: "inline-flex min-h-9 w-full items-center justify-center gap-2 rounded-md border border-dashed border-blue-300/80 bg-transparent px-3 py-2 text-[13px] font-bold text-blue-600 transition-colors hover:border-blue-400 hover:bg-blue-50/40 ".concat(isRTL ? 'flex-row-reverse' : ''),
                children: [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "rounded-full bg-blue-100 px-3 py-1 text-xs font-bold text-blue-600",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-1 max-w-3xl text-xs font-semibold leading-relaxed text-slate-500 sm:text-[13px]",
                        children: subtitle
                    }, void 0, false, {
                        fileName: "[project]/components/project/questions/ProjectSubscopesQuestion.tsx",
                        lineNumber: 1144,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-4 space-y-4 pb-[130px] lg:pb-0",
                        ...
                        selectedParents.map((parent)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-wrap items-start justify-between gap-2 ".concat(isRTL ? 'text-right' : 'text-left'),
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "min-w-0 text-base font-bold leading-tight text-slate-900",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        children.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            type: "button",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "rounded-full bg-blue-100 px-2.5 py-1 text-xs font-bold text-blue-600",
                                        ...
                                        children.length === 0 ? !otherOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                children.map((child)=>{
                                                    ...
                                                    const key = "".concat(parent.id, ":").concat(child.id);
                                                    ...
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        ...
                                                                        className: "flex min-w-0 flex-1 items-start gap-2.5 ".concat(isRTL ? 'text-right' : 'text-left'),
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border ".concat(checked ? 'border-blue-500 bg-blue-500' : 'border-slate-300 bg-white/80'),
                                                                                "aria-hidden": "true",
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "min-w-0 text-[13px] font-semibold leading-snug text-slate-700 ".concat(checked ? 'text-blue-900' : '', " ").concat(isRTL ? 'text-right' : 'text-left'),
                                                                                children: child.name
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/components/project/questions/ProjectSubscopesQuestion.tsx",
                                                                                lineNumber: 1234,
                                                            ...
                                                            checked && attachments.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: attachments.map((file, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AttachmentTile, {
                                                                        file: file,
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    customSubscopes.map((sub)=>{
                                                        const key = "".concat(scopeKey, ":").concat(sub.id);
                                                        const attachments = attachmentsByKey[key] || [];
                                                        ...
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex min-h-[46px] flex-col justify-center border-b border-slate-200/80 py-2.5",
                                                            children: [
                                                                isFinalized ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "space-y-2",
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "flex items-start justify-between gap-2",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                                ...
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                        className: "inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border ".concat(isConfirmed ? 'border-blue-500 bg-blue-500' : 'border-slate-300 bg-white/80'),
                                                                                        "aria-hidden": "true",
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                        className: "min-w-0 text-[13px] font-semibold leading-snug text-slate-700 ".concat(isConfirmed ? 'text-blue-900' : '', " ").concat(isRTL ? 'text-right' : 'text-left'),
                                                                                        children: sub.name
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/components/project/questions/ProjectSubscopesQuestion.tsx",
                                                                                        lineNumber: 1308,
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                                    ...
                                                                                    className: "inline-flex h-7 w-7 items-center justify-center rounded-md bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 active:bg-emerald-700 ".concat(hasName ? '' : 'cursor-not-allowed opacity-45'),
                                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconCheck$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconCheck$3e$__["IconCheck"], {
                                                                                        size: 14,
                                                                                        stroke: 2
                                                                                    }, void 0, false, {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "shrink-0 rounded-full bg-blue-100 px-2.5 py-1 text-xs font-bold text-blue-600",
                                                    children: selectedCountLabel(selectedCount)
                                                }, void 0, false, {
                                                    fileName: "[project]/components/project/questions/ProjectSubscopesQuestion.tsx",
                                                    lineNumber: 1415,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8 pt-4 pb-[calc(env(safe-area-inset-bottom)+1rem)]",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProjectSubscopesQuestion, "ykCqLon9+9utfk21eDarvGolQtk=", false, function() {
    return [
...
_c1 = ProjectSubscopesQuestion;
var _c, _c1;
__turbopack_context__.k.register(_c, "AttachmentTile");
__turbopack_context__.k.register(_c1, "ProjectSubscopesQuestion");
...
//# sourceMappingURL=components_project_questions_ProjectSubscopesQuestion_tsx_a661c4cc._.js.map