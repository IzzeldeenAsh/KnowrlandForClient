...
"[project]/components/auth/pages/Callback.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Callback(param) {
    ...
    const [agreement, setAgreement] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const destination = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("/".concat(locale));
    const rawReturn = search.get('returnUrl') || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authToken$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTokenFromCookie"])('auth_return_url') || (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authToken$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTokenFromCookie"])('signUpReturnUrl');
    function navigate() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeAuthCookie"])('auth_return_url', '', 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeAuthCookie"])('signUpReturnUrl', '', 0);
        const safe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSafeReturnUrl"])(destination.current) || "/".concat(locale);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Callback.useEffect": ()=>{
            ...
            async function complete() {
                try {
                    var _accepted_value_data, _accepted_value;
                    ...
                    if (incoming) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storeSession"])(incoming);
                    }
                    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authToken$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthToken"])();
                    if (!token) {
                        router.replace((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authPageUrl"])('signin', locale, rawReturn));
                        return;
                    }
                    let user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["takeLoginUser"])() || (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authRequest"])('account/profile', locale)).data;
                    if (user.verified === false) {
                        router.replace((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authPageUrl"])('verify-email', locale, rawReturn));
                        return;
                    }
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["seedProfile"])(user);
                    ...
                    void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authRequest"])('account/timezone/set', locale, {
                    ...
                    const professional = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasInsighterPromptRole"])(roles);
                    destination.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSafeReturnUrl"])(rawReturn) || (professional ? "".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAngularAppOrigin"])(), "/app/insighter-dashboard/my-dashboard") : "/".concat(locale));
                    const [prompts, insighter, accepted] = await Promise.allSettled([
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOnboardingPromptStatuses"])({
                            token,
                            locale
                        }),
                        professional ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchInsighterPromptStatuses"])({
                            token,
                            locale
                        }) : Promise.resolve([]),
                        professional ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authRequest"])('account/agreement/check', locale) : Promise.resolve({
                            data: {
                                accept: true
                            }
                        })
                    ]);
                    if (insighter.status === 'fulfilled' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVisibleInsighterPrompts"])(insighter.value).length) destination.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withInsighterSetupMarker"])(destination.current);
                    if (prompts.status === 'fulfilled' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVisibleSupportedPrompts"])(prompts.value).length) destination.current = "/".concat(locale, "/onboarding?redirect=").concat(encodeURIComponent(destination.current));
                    // Preserve the existing agreement failure/skip behavior.
                    if (accepted.status === 'fulfilled' && ((_accepted_value = accepted.value) === null || _accepted_value === void 0 ? void 0 : (_accepted_value_data = _accepted_value.data) === null || _accepted_value_data === void 0 ? void 0 : _accepted_value_data.accept) === false) {
                        setAgreement(roles.includes('company') ? 'company_agreement' : 'insighter_agreement');
                        return;
                    }
                    navigate();
                } catch (e) {
                    if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthError"] && e.status === 401) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearSession"])();
                        router.replace((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authPageUrl"])('signin', locale, rawReturn));
                        return;
                    }
                    if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthError"] && e.status === 403 && /verif/i.test(e.message)) {
                        router.replace((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authPageUrl"])('verify-email', locale, rawReturn));
                        return;
                    }
...
_s(Callback, "PtDKiIM+16+hMxHFDNT+2Ob96k0=", false, function() {
    return [
...
//# sourceMappingURL=_a723ecf0._.js.map