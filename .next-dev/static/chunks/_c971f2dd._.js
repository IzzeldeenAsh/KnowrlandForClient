...
"[project]/components/onboarding/InsighterSetupCover.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/onboarding.service.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$onboarding$2f$InsighterSetupCover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/components/onboarding/InsighterSetupCover.tsx [app-client] (ecmascript) <locals>");
                ...
                "OnboardingPage.useCallback[navigateAfterOnboarding]": async ()=>{
                    ...
                    /** Adds the marker to whichever URL we end up sending the user to. */ const withMarker = {
                        "OnboardingPage.useCallback[navigateAfterOnboarding].withMarker": (url)=>{
                            ...
                            try {
                                const parsed = new URL(url, window.location.origin);
                                parsed.searchParams.set(__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$onboarding$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INSIGHTER_SETUP_QUERY_KEY"], '1');
                                return url.startsWith('http') ? parsed.toString() : "".concat(parsed.pathname).concat(parsed.search).concat(parsed.hash);
                            } catch (e) {
                                return url;
                            }
                        }
...
//# sourceMappingURL=_c971f2dd._.js.map