...
const copyByLocale = {
    en: {
        ...
        bodyTooLong: "The formatted article must be ".concat(ARTICLE_BODY_LIMIT.toLocaleString(), " characters or fewer."),
    ...
    ar: {
        ...
        bodyTooLong: "يجب ألا يتجاوز المقال المنسق ".concat(ARTICLE_BODY_LIMIT.toLocaleString(), " حرفاً."),
...
_s(ArticleEditor, "3ZjsTwBnSiTBHDikfBbUEr5BQtE=", false, function() {
    return [
