    ...
    async function submit(event) {
        ...
        try {
            ...
            if (user.verified === false) {
                router.replace((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authRedirect$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authPageUrl"])('verify-email', locale, returnUrl) + "".concat(returnUrl ? '&' : '?', "email=").concat(encodeURIComponent(user.email), "&resend=1"));
            } else {
...
//# sourceMappingURL=_af990a69._.js.map