...
function AlignTest() {
    ...
    const editor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useEditor"])({
        ...
        onUpdate: {
            "AlignTest.useEditor[editor]": (param)=>{
                let { editor } = param;
                return setHtml(editor.getHTML());
            }
        }["AlignTest.useEditor[editor]"]
    });
...
_s(AlignTest, "S6RdBZhYeH9YDP7C4dbZYQxG3ig=", false, function() {
    return [
...
//# sourceMappingURL=app_%5Blocale%5D_align-test_page_tsx_36166e25._.js.map