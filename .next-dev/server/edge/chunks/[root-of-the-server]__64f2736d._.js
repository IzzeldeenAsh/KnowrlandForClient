...
;
const imageModule = {
    ...__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$icon$2e$tsx__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__
};
...
async function GET(_, ctx) {
    ...
    if (generateImageMetadata) {
        ...
        if (id == null) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$app$2d$edge$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Not Found', {
                status: 404
            });
        }
    }
