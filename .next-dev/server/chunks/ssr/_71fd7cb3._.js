...
function KnowledgeAuthorActions({ locale, isOwner, insighter, className = "" }) {
    ...
    const canRequestService = (isCompanyMemberInsight || isIndividualInsighterInsight) && serviceTarget?.receiveProjectServicesActive === true && Boolean(serviceTarget.specifiedInsighterUuid);
