...
const isDevelopment = FORCE_DEVELOPMENT || ("TURBOPACK compile-time value", "development") === 'development';
const apiBaseUrl = ("TURBOPACK compile-time truthy", 1) ? 'https://api.foresighta.co' : "TURBOPACK unreachable";
const publicBaseUrl = process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000';
const appBaseUrl = ("TURBOPACK compile-time truthy", 1) ? 'http://localhost:3000' : "TURBOPACK unreachable";
