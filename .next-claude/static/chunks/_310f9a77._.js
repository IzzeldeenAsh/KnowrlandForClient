...
"[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function KnowledgeListView(param) {
    let { status = '' } = param;
    _s();
    ...
    const [confirmBusy, setConfirmBusy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const hadResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const isCompanyInsighter = hasRole('company-insighter');
    const load = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "KnowledgeListView.useCallback[load]": (targetPage, keyword, type)=>{
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$insighter$2d$dashboard$2e$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMyKnowledgeList"])(locale, {
                page: targetPage,
                status: status || undefined,
                keyword,
                type
            }).then({
                "KnowledgeListView.useCallback[load]": (res)=>{
                    var _res_meta, _res_meta1;
                    var _res_data;
                    setItems((_res_data = res.data) !== null && _res_data !== void 0 ? _res_data : []);
                    var _res_meta_last_page;
                    setLastPage((_res_meta_last_page = (_res_meta = res.meta) === null || _res_meta === void 0 ? void 0 : _res_meta.last_page) !== null && _res_meta_last_page !== void 0 ? _res_meta_last_page : 1);
                    var _res_meta_current_page;
                    setPage((_res_meta_current_page = (_res_meta1 = res.meta) === null || _res_meta1 === void 0 ? void 0 : _res_meta1.current_page) !== null && _res_meta_current_page !== void 0 ? _res_meta_current_page : targetPage);
                    var _res_data1;
                    if (((_res_data1 = res.data) !== null && _res_data1 !== void 0 ? _res_data1 : []).length > 0) hadResults.current = true;
                    setSelected(new Set());
                }
            }["KnowledgeListView.useCallback[load]"]).catch({
                "KnowledgeListView.useCallback[load]": (err)=>toast.handleServerErrors(err)
            }["KnowledgeListView.useCallback[load]"]).finally({
                "KnowledgeListView.useCallback[load]": ()=>setLoading(false)
            }["KnowledgeListView.useCallback[load]"]);
        }
    }["KnowledgeListView.useCallback[load]"], // eslint-disable-next-line react-hooks/exhaustive-deps
    [
        locale,
        status
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "KnowledgeListView.useEffect": ()=>{
            load(1, '', '');
        }
    }["KnowledgeListView.useEffect"], [
        load
    ...
    const canShowDelete = (k)=>{
        var _k_account_manager_process;
        const requestStatus = (_k_account_manager_process = k.account_manager_process) === null || _k_account_manager_process === void 0 ? void 0 : _k_account_manager_process.request_status;
    ...
    const askDelete = (ids)=>{
        setConfirm({
            ...
            danger: true,
            action: async ()=>{
                await Promise.all(ids.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$insighter$2d$dashboard$2e$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteMyKnowledge"])(locale, id)));
    ...
    const askUnpublish = (k)=>{
        setConfirm({
            ...
            action: async ()=>{
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$insighter$2d$dashboard$2e$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMyKnowledgeStatus"])(locale, k.id, 'unpublished', new Date().toISOString());
    ...
    const askPublish = (k)=>{
        setConfirm({
            ...
            action: async ()=>{
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$insighter$2d$dashboard$2e$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMyKnowledgeStatus"])(locale, k.id, 'published', new Date().toISOString());
    ...
    const statusLabel = (k)=>{
        ...
        const key = (_k_status = k.status) === null || _k_status === void 0 ? void 0 : _k_status.toLowerCase();
        return t.has("status.".concat(key)) ? t("status.".concat(key)) : k.status;
    };
    const viewHref = (k)=>"/".concat(locale, "/my-knowledge-base/view-my-knowledge/").concat(k.id);
    const addHref = "/".concat(locale, "/add-knowledge/stepper");
    const rowActions = (k)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                status === 'published' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    type: "button",
                ...
                status !== 'published' && canShowDelete(k) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    type: "button",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            (items.length > 0 || emptyWithFilters || hadResults.current) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "rounded-s-lg p-2 ".concat(view === 'grid' ? 'bg-gray-100 text-gray-900' : 'text-gray-400'),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "rounded-e-lg p-2 ".concat(view === 'list' ? 'bg-gray-100 text-gray-900' : 'text-gray-400'),
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconList$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconList$3e$__["IconList"], {
                                            size: 16
                                        }, void 0, false, {
                                            fileName: "[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-4",
                children: [
                    (items.length > 0 || emptyWithFilters) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-4 flex flex-wrap gap-2",
                        children: KNOWLEDGE_TYPES.map((type)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>onTypeFilter(type),
                                className: "rounded-full border px-3 py-1 text-xs font-semibold transition-colors ".concat(typeFilter === type ? 'border-sky-500 bg-sky-50 text-sky-600' : 'border-gray-200 text-gray-500 hover:border-gray-300'),
                                children: t("types.".concat(type || 'all'))
                            }, type || 'all', false, {
                                fileName: "[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx",
                                lineNumber: 289,
                                columnNumber: 15
                    ...
                    !loading && items.length > 0 && view === 'list' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        ...
                                                        children: ((_k_title = k.title) === null || _k_title === void 0 ? void 0 : _k_title.trim()) || t('untitled')
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx",
                                                        lineNumber: 377,
                                                        columnNumber: 23
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                ...
                                                                children: t.has("types.".concat(k.type)) ? t("types.".concat(k.type)) : k.type
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx",
                                                                lineNumber: 384,
                                                                columnNumber: 25
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: [
                                                            k.publish_as !== 'package' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "rounded-md px-2 py-1 text-xs font-semibold capitalize ".concat(statusBadgeClass(k.status)),
                                                            ...
                                                            (k.publish_as === 'both' || k.publish_as === 'package') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    !loading && items.length > 0 && view === 'grid' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    !loading && items.length > 0 && lastPage > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: Array.from({
                            length: lastPage
                                ...
                                className: "min-w-[32px] rounded-md px-2 py-1.5 text-sm font-medium ".concat(p === page ? 'bg-sky-500 text-white' : 'text-gray-600 hover:bg-gray-100'),
                                children: p
                            }, p, false, {
                                fileName: "[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx",
                                lineNumber: 468,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Modal$2f$Modal$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Modal"], {
                ...
                title: confirm === null || confirm === void 0 ? void 0 : confirm.title,
                centered: true,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                disabled: confirmBusy,
                                onClick: runConfirm,
                                className: "rounded-lg px-4 py-2 text-sm font-semibold text-white ".concat((confirm === null || confirm === void 0 ? void 0 : confirm.danger) ? 'bg-red-500 hover:bg-red-600' : 'bg-sky-500 hover:bg-sky-600', " ").concat(confirmBusy ? 'opacity-60' : ''),
                                children: confirm === null || confirm === void 0 ? void 0 : confirm.confirmLabel
                            }, void 0, false, {
                                fileName: "[project]/components/insighter-dashboard/my-knowledge/KnowledgeListView.tsx",
                                lineNumber: 500,
                                columnNumber: 11
...
_s(KnowledgeListView, "msBvuheaIN1UeMEU5cqgU9Px5Pk=", false, function() {
    return [
...
_c = KnowledgeListView;
var _c;
__turbopack_context__.k.register(_c, "KnowledgeListView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_310f9a77._.js.map