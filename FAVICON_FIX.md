...
✅ `https://foresighta.co/favicon.ico` → 200 OK (served from public/favicon.ico)
✅ `https://foresighta.co/icon.png` → 200 OK (generated by app/icon.tsx)
✅ `https://foresighta.co/apple-icon.png` → 200 OK (generated by app/apple-icon.tsx)
...
curl -I https://foresighta.co/icon.png
curl -I https://foresighta.co/apple-icon.png
```
