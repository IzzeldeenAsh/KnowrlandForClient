...
✅ `http://localhost:3000/favicon.ico` → 200 OK (served from public/favicon.ico)
✅ `http://localhost:3000/icon.png` → 200 OK (generated by app/icon.tsx)
✅ `http://localhost:3000/apple-icon.png` → 200 OK (generated by app/apple-icon.tsx)
