                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        ...
                        <div>
                          {/*
                            Original link text (2 words): "Learn more"
                          */}
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
                        <Image className="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:max-w-full md:relative md:left-0 md:translate-x-0" src={FeatureImg02} width={536} height={230} alt="Lorem Ipsum" />
                      </div>
                    </div>
                  </div>
                </HighlighterItem>
                ...
                <HighlighterItem>
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      {/* Image */}
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
                        <Image className="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:max-w-full md:relative md:left-0 md:translate-x-0" src={FeatureImg03} width={230} height={230} alt="Lorem Ipsum" />
                      </div>
                    </div>
                  </div>
                </HighlighterItem>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                {/*
                  Original heading (1 word): "Filters"
                */}
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                {/*
                  Original heading (1 word): "Configurable"
                */}
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                {/*
                  Original heading (1 word): "Adaptable"
                */}
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <svg className="shrink-0 fill-slate-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                  <path d="M14 0a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12Zm0 14V2H2v12h12Zm-3-7H5a1 1 0 1 1 0-2h6a1 1 0 0 1 0 2Z" />
                </svg>
                {/*
                  Original heading (1 word): "Authorization"
                */}
                <h4 className="font-medium text-slate-50">Sit</h4>
              </div>
              <p className="text-sm text-slate-400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.
              </p>
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                {/*
                  Original heading (1 word): "Management"
                */}
                <h4 className="font-medium text-slate-50">Amet</h4>
              </div>
              <p className="text-sm text-slate-400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.
              </p>
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                {/*
                  Original heading (1 word): "Building"
                */}
                <h4 className="font-medium text-slate-50">Consectetur</h4>
              </div>
              <p className="text-sm text-slate-400">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.
              </p>
