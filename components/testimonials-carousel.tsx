        ...
        <div className="pt-12 md:pt-20">
              ...
              <Highlighter className="swiper-wrapper w-fit" refresh={swiperInitialized}>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      {/*
                        Original alt text (2 words): "Icon 01"
                        Replacement: "Lorem Ipsum"
                      */}
                      <Image className="mb-3" src={CarouselImg01} width={56} height={56} alt="Lorem Ipsum" />
                      <div className="grow">
                        {/*
                          Original title (2 words): "Anonymous User"
                          Replacement: "Lorem Ipsum"
                        */}
                        <div className="font-bold text-lg mb-1">Lorem Ipsum</div>
                        {/*
                          Original description (8 words): "Incorporate rich user profiling, and facilitate more transactions."
                          Replacement (8 words): "Lorem ipsum dolor sit amet, consectetur adipiscing elit"
                        */}
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      <Image className="mb-3" src={CarouselImg02} width={56} height={56} alt="Lorem Ipsum" />
                      <div className="grow">
                        {/*
                          Original title (2 words): "Bot Detection"
                          Replacement: "Lorem Ipsum"
                        */}
                        <div className="font-bold text-lg mb-1">Lorem Ipsum</div>
                        <div className="text-slate-400 mb-3">
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      <Image className="mb-3" src={CarouselImg03} width={56} height={56} alt="Lorem Ipsum" />
                      <div className="grow">
                        {/*
                          Original title (2 words): "Social integrations"
                          Replacement: "Lorem Ipsum"
                        */}
                        <div className="font-bold text-lg mb-1">Lorem Ipsum</div>
                        <div className="text-slate-400 mb-3">
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      <Image className="mb-3" src={CarouselImg04} width={56} height={56} alt="Lorem Ipsum" />
                      <div className="grow">
                        {/*
                          Original title (2 words): "Progressive Profiling"
                          Replacement: "Lorem Ipsum"
                        */}
                        <div className="font-bold text-lg mb-1">Lorem Ipsum</div>
                        <div className="text-slate-400 mb-3">
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      {/*
                        Original alt text (2 words): "Icon 05"
                        Replacement: "Lorem Ipsum"
                      */}
                      <Image className="mb-3" src={CarouselImg05} width={56} height={56} alt="Lorem Ipsum" />
                      <div className="grow">
                        {/*
                          Original title (2 words): "Secure Access"
                          Replacement: "Lorem Ipsum"
                        */}
                        <div className="font-bold text-lg mb-1">Lorem Ipsum</div>
                        <div className="text-slate-400 mb-3">
          ...
          <div className="flex mt-8 justify-end">
            <button className="carousel-prev relative z-20 w-12 h-12 flex items-center justify-center group">
              {/*
                Original sr-only text: "Previous" (1 word)
                Replacement: "Lorem"
              */}
            ...
            <button className="carousel-next relative z-20 w-12 h-12 flex items-center justify-center group">
              {/*
                Original sr-only text: "Next" (1 word)
                Replacement: "Ipsum"
              */}
