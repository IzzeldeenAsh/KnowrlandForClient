...
export default function FolderIcon({ width = 46, height = 34 }: FolderIconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 46 34" fill="none" xmlns="http://www.w3.org/2000/svg">
