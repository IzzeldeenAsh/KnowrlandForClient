      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-400 mb-8">Find out about our latest product changes as we continue improving Knoldg to enable your team to collaborate better.</p>
