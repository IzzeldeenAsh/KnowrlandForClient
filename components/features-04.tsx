      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            {/*
              Original h2 text (3 words): "Why trust us?"
              Replacement (3 words): "Lorem ipsum dolor"
            */}
            ...
            {/*
              ...
              Replacement (29 words):
              "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, truly in every single instance."
            */}
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                {/*
                  Original inline title (2 words): "API Authorization"
                  Replacement (2 words): "Lorem Ipsum"
                */}
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-200 pb-6">
                  Lorem Ipsum
                </div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (1 word): "Discussions"
                      Replacement (1 word): "Lorem"
                    */}
                    <h4 className="font-medium text-slate-50">Lorem</h4>
                  </div>
                  {/*
                    Original description (14 words): 
                    "Login box must find the right balance for the user convenience, privacy and security."
                    
                    Replacement (14 words): 
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor in toto."
                  */}
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (2 words): "Team views"
                      Replacement (2 words): "Lorem Ipsum"
                    */}
                    <h4 className="font-medium text-slate-50">Lorem Ipsum</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor in toto.
                  </p>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (2 words): "Powerful search"
                      Replacement (2 words): "Lorem Ipsum"
                    */}
                    <h4 className="font-medium text-slate-50">Lorem Ipsum</h4>
                  </div>
            ...
            <div className="py-8">
              <div>
                {/*
                  Original inline title (2 words): "User Management"
                  Replacement (2 words): "Lorem Ipsum"
                */}
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-200 pb-6">
                  Lorem Ipsum
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (1 word): "Analytics"
                      Replacement (1 word): "Lorem"
                    */}
                    <h4 className="font-medium text-slate-50">Lorem</h4>
                  </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (1 word): "Notifications"
                      Replacement (1 word): "Ipsum"
                    */}
                    <h4 className="font-medium text-slate-50">Ipsum</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor in toto.
                  </p>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (2 words): "Powerful search"
                      Replacement (2 words): "Sit Amet"
                    */}
                    <h4 className="font-medium text-slate-50">Sit Amet</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor in toto.
                  </p>
            ...
            <div className="py-8">
              <div>
                {/*
                  Original inline title (2 words): "Standard Security"
                  Replacement (2 words): "Lorem Ipsum"
                */}
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-200 pb-6">
                  Lorem Ipsum
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (1 word): "Privacy"
                      Replacement (1 word): "Dolor"
                    */}
                    <h4 className="font-medium text-slate-50">Dolor</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor in toto.
                  </p>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (2 words): "Data export"
                      Replacement (2 words): "Lorem Ipsum"
                    */}
                    <h4 className="font-medium text-slate-50">Lorem Ipsum</h4>
                  </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    {/*
                      Original feature title (2 words): "Real-time sync"
                      Replacement (2 words): "Lorem Ipsum"
                    */}
                    <h4 className="font-medium text-slate-50">Lorem Ipsum</h4>
                  </div>
