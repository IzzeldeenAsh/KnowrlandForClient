...
const isChangesRequestedLabel = (subTypeValue?: string): boolean => {
  ...
  const handleNotificationClick = useCallback(
    async (notification: Notification) => {
      ...
      if (notification.type === 'knowledge' && notification.category) {
        const knowledgeUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/${currentLanguage}/knowledge/${notification.category}/${notification.param || ''}?tab=ask`
      ...
      if (notification.type === 'order') {
        url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/app/insighter-dashboard/sales?tab=2`
      } else if (notification.sub_type.startsWith('client_meeting_reminder')) {
        url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/app/insighter-dashboard/my-meetings?tab=client`
      } else if (notification.sub_type === 'accept_knowledge') {
        url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/app/insighter-dashboard/my-requests`
      } else if (notification.sub_type === 'client_meeting_new') {
        url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/app/insighter-dashboard/my-meetings?tab=client`
      } else if (notification.sub_type === 'declined' && notification.type === 'knowledge') {
        url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/app/my-knowledge-base/view-my-knowledge/${notification.param}/details`
        ...
        url = `${process.env.NEXT_PUBLIC_DASHBOARD_URL}/app/insighter-dashboard/my-meetings/sent`
