      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <ul className="text-sm space-y-2 text-start">
              <li>
                <a className="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href={`/${locale}/about`}>Client Guide</a>
              </li>
              <li>
                <a className="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href={`/${locale}/blog`}>Insighter Guide</a>
              </li>
              <li>
                <a className="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href={`/${locale}/contact`}>Company Guide</a>
              </li>
            </ul>
          </div>
