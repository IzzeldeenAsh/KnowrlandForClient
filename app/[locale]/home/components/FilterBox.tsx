...
const FilterBox: React.FC<FilterBoxProps> = ({
  ...
  useEffect(() => {
    const fetchCountries = async () => {
      setLoading(true);
      try {
        const response = await fetch('https://api.knoldg.comm/api/common/setting/country/list', {
          headers: {
    ...
    const fetchRegions = async () => {
      ...
      try {
        const response = await fetch('https://api.knoldg.comm/api/common/setting/region/list', {
          headers: {
            'Accept-Language': locale,
            'Accept': 'application/json',
            "X-Timezone": Intl.DateTimeFormat().resolvedOptions().timeZone,
    ...
    const fetchEconomicBlocs = async () => {
      ...
      try {
        const response = await fetch('https://api.knoldg.comm/api/common/setting/economic-bloc/list', {
          headers: {
            'Accept-Language': locale,
            'Accept': 'application/json',
            "X-Timezone": Intl.DateTimeFormat().resolvedOptions().timeZone,
    ...
    const fetchIsicCodes = async () => {
      ...
      try {
        const response = await fetch('https://api.knoldg.comm/api/common/setting/isic-code/tree-list', {
          headers: {
            'Accept-Language': locale,
            'Accept': 'application/json',
            "X-Timezone": Intl.DateTimeFormat().resolvedOptions().timeZone,
    ...
    const fetchIndustries = async () => {
      ...
      try {
        const response = await fetch('https://api.knoldg.comm/api/common/setting/industry/tree', {
          headers: {
            'Accept-Language': locale,
            'Accept': 'application/json',
            "X-Timezone": Intl.DateTimeFormat().resolvedOptions().timeZone,
  ...
  useEffect(() => {
    const fetchHsCodes = async (isicCodeId: number) => {
      ...
      try {
        const response = await fetch(`https://api.knoldg.comm/api/common/setting/hs-code/isic-code/${isicCodeId}`, {
          headers: {
            'Accept-Language': locale,
            'Accept': 'application/json',
            "X-Timezone": Intl.DateTimeFormat().resolvedOptions().timeZone,
