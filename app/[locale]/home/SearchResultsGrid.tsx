              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={`${cardStyles.darkSection} ${showBottomMeta ? cardStyles.darkSectionWithBottomMeta : ""
                        } relative`}
                    >
                      <div>
                      ...
                      {showBottomMeta && (
                        <div
                          className={`${cardStyles.bottomMetaRow} ${isRTL ? cardStyles.bottomMetaRowRtl : ""
