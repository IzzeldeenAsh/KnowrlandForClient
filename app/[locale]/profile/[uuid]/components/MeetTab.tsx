                  ...
                  <div className="grid grid-cols-1 gap-3 sm:gap-4">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        const loginUrl = `http://localhost:4200/auth/login?returnUrl=${encodeURIComponent(
                          authRedirectUrl
                        )}`;
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (!authRedirectUrl) return;
                        const signupUrl = `http://localhost:4200/auth/sign-up?returnUrl=${encodeURIComponent(
                          authRedirectUrl
                        )}`;
          ...
          <div className="text-center py-8">
            ...
            <Button
              ...
              onClick={() => {
                ...
                window.location.href = "http://localhost:4200/app/insighter-dashboard/my-meetings?tab=my-meetings";
              }}
            >
