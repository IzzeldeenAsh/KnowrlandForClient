...
<svg className={`${styles.icon} ${styles.iconData} ${isActive ? styles.iconActive : ''}`} width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-white max-w-6xl mx-auto dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="100">
            ...
            <Tabs defaultValue={searchParams.get('tab') || "knowledge"} onChange={handleTabChange} styles={{
              ...
              <Tabs.List className="border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/80">
                ...
                {(isInsighter || isCompanyInsighter || isCompany) && !isOwnProfile && enterpriseType === 'insighter' && (
                  <Tabs.Tab
                    value="meet"
                    className="text-base font-medium px-8 py-4 transition"
                  >
                    ...
                    {knowledgeTypes.map((type) => {
                      ...
                      return (
                        <button
                          ...
                          className={`${styles.filterButton} ${isActive ? `${styles.filterButtonActive} ${type.filterClass}` : ''}`}
                        >
