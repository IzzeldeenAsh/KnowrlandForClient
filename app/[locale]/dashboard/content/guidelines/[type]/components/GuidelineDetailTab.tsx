...
export default function GuidelineDetailTab() {
    ...
    async (signal?: AbortSignal) => {
      ...
      try {
        const [typesRes, currentRes, lastRes] = await Promise.all([
          fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/common/setting/guideline/type`, {
            method: 'GET',
            cache: 'no-store',
            signal,
            headers: { Accept: 'application/json', 'Accept-Language': 'en' },
          }),
          fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/common/setting/guideline/type/current/${encodeURIComponent(type)}`, {
            method: 'GET',
            cache: 'no-store',
            signal,
            headers: { Accept: 'application/json', 'Accept-Language': 'en' },
          }),
          fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/common/setting/guideline/type/last/${encodeURIComponent(type)}`, {
            method: 'GET',
            cache: 'no-store',
            signal,
            headers: { Accept: 'application/json', 'Accept-Language': 'en' },
  ...
  const createVersion = async (payload: AddVersionPayload) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/setting/guideline`, {
        method: 'POST',
        cache: 'no-store',
        headers,
        body: formData,
