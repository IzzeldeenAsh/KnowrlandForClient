...
import { ClientGuideNavbar } from '@/components/ClientGuideNavbar/ClientGuideNavbar'
import Footer from '@/components/ui/footer'
import { IconMenu2, IconX } from '@tabler/icons-react'
import PageIllustration from '@/components/page-illustration'
import { useLocale } from 'next-intl'

export default function ClientGuideLayout({
  children,
}: {
        ...
        <div className="relative z-10 flex min-h-screen w-full justify-center pt-0 lg:pt-0">
          <div className="flex w-full min-h-screen">
            <div
              ...
              `}
            >
              <ClientGuideNavbar onLinkClick={() => setIsMobileMenuOpen(false)} />
            </div>
